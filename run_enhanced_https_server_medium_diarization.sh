...
# Enhanced WhisperLiveKit HTTPS Server Runner with Medium Model and Diarization
# This script runs the enhanced server with SSL support, medium model, and diarization

echo "🔒 Starting Enhanced WhisperLiveKit HTTPS Server (Medium + Diarization)"
echo "======================================================================"
...
export CALLING_SCRIPT="run_enhanced_https_server_medium_diarization.sh"
...
# Start the enhanced HTTPS server with medium model and diarization
...
echo "🎤 Model: medium (higher accuracy)"
