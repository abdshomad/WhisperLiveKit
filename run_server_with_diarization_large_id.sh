...
echo "Host: $HOST"
echo "Port: $PORT"
echo "Features: Advanced Speaker Diarization, Large Model, Indonesian Language, MP3 Recording"
echo "Diarization Models: pyannote/segmentation-3.0 + speechbrain/spkrec-ecapa-voxceleb"
echo "Advanced Features: Punctuation-based speaker splitting, VAC, Confidence validation, MP3 audio storage"
